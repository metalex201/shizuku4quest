...
This app is a modified version of Shizuku, which can be found [here](https://github.com/RikkaApps/Shizuku-API/), this modified version is not affiliated with the original creator of Shizuku. 
...
Currently the app has only been tested on quest 3
## Background
